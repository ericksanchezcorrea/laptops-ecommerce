// BASE URL BACKEND
export const REACT_APP_BASE_URL = process.env.REACT_APP_BASE_URL || 'http://localhost:4000'
...
export const REACT_APP_MESSAGE_IN_SENDER_ID = process.env.REACT_APP_MESSAGE_IN_SENDER_ID
